...
BEGIN
    SELECT
        ...
        SUM(IT.PS_SERVICOITEM) - COALESCE(SUM(EO.PS_PEDIDO), 0) PS_PEDIDO,
        SUM(IT.QT_SERVICOITEM) - COALESCE(SUM(EO.QT_PEDIDA), 0) QT_PEDIDA,
    ...
    GROUP BY IT.CD_ITEM, I.DS_ITEM, IT.CD_VENDEDOR, OS.CD_PESSOA
    ...
    BEGIN
       ...
       VALUES (:V_ID, :I_CD_EMPRESA, :I_NR_ORCAMENTO, :V_CD_ITEM, :V_DS_ITEM, :V_CD_VENDEDOR, :V_CD_CLIENTE, :V_QT_SERVICOITEM, :V_PS_SERVICOITEM, :I_NM_SEPARADOR, 'I', CURRENT_TIMESTAMP, NULL);
    END

    /*VALIDA SE O REGISTRO EXISTE NA TABELA*/
    IF (:V_CD_ITEM IS NOT NULL) THEN
    BEGIN
