...
"font: 75 12pt \"Arial\";")
        ...
        if (self.TW_ordemservico.columnCount() < 15):
            self.TW_ordemservico.setColumnCount(15)
        ...
        # Tamanho colunas
        self.TW_ordemservico.setColumnWidth(10, 200)
        self.TW_ordemservico.setColumnWidth(11, 200)
        self.TW_ordemservico.setColumnWidth(12, 340)
        ...
        __qtablewidgetitem20.setTextAlignment(Qt.AlignHCenter|Qt.AlignBottom);
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"Or\u00e7amento", None));
        ...
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"Vendedor", None));
        ___qtablewidgetitem22 = self.TW_ordemservico.horizontalHeaderItem(12)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"Item", None));
        ___qtablewidgetitem23 = self.TW_ordemservico.horizontalHeaderItem(13)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("MainWindow", u"Quant.", None));
        ___qtablewidgetitem24 = self.TW_ordemservico.horizontalHeaderItem(14)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("MainWindow", u"Separador", None));
    # retranslateUi
